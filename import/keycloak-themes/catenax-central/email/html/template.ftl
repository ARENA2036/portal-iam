...
<html>
  <head>
    ...
    <table width="100%" bgcolor="#FF6200" cellspacing="10" cellpadding="0"><tr><td>
    ...
    <table width="100%" bgcolor="#FF6200" cellspacing="10" cellpadding="15"><tr><td>
...
<#if link??>
<table class="button" bgcolor="#FF6200" cellspacing="15" cellpadding="10"><tr><td>
