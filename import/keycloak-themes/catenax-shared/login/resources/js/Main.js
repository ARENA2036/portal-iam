...
class FormLogin extends Form {
    ...
    constructor(form) {
        super(
            N('div', [
                N('h3', 'Register to Construct-X'),
                N('p', 'Finish the company registration form to join Construct-X. Please use your email address as username and enter your password.'),
                form
            ])
        )
        setTimeout((() => {
