...
class FormLogin extends Form {
    ...
    constructor(form) {
        super(
            N('div', [
                N('h3', 'Register to ARENA2036-X'),
                N('p', 'Finish the company registration form to join ARENA2036-X network. Please use your email address as username and enter your password.'),
                form
            ])
        )
        setTimeout((() => {
